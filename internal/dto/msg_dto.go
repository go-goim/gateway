...
type SendMessageReq struct {
	From        *model.ID `json:"from" validate:"required" swaggertype:"string" example:"av8FMdRdcb"`
	To          *model.ID `json:"to" validate:"required" swaggertype:"string" example:"av8FMdRdcb"`
...
type Message struct {
	MessageID   int64     `json:"messageId" example:"1"`
	From        *model.ID `json:"from" swaggertype:"string" example:"av8FMdRdcb"`
	To          *model.ID `json:"to" swaggertype:"string" example:"av8FMdRdcb"`
...
func MessageFromPb(pb *messagev1.Message) *Message {
	return &Message{
		MessageID:   pb.GetMsgId(),
		From:        model.NewID(pb.GetFrom()),
		To:          model.NewID(pb.GetTo()),
